({
    fetchData: function (component, fetchData, numberOfRecords) {
        ...
        action.setCallback(this, function(response){
            ...
            if (state === "SUCCESS") {
                ...
                var listSize = response.getReturnValue().length;
                console.log('OrderItemList Size-- ' + listSize );
                // Added by rajasekhar
                if(listSize != null && listSize >10000){
                    component.set('v.hasMoreRows', true); 
                    component.set('v.totalRecordsSize', listSize);
                    component.set('v.data', response.getReturnValue());
                    //component.set('v.filteredData', response.getReturnValue());
                }
                else{
                    component.set('v.hasMoreRows', false); 
                    component.set('v.totalRecordsSize', listSize);
                    component.set('v.data', response.getReturnValue());
                    component.set('v.filteredData', response.getReturnValue());
                }
    ...
    fetchTopData: function (component) {
        ...
        action.setCallback(this, function(response){
            ...
            if (state === "SUCCESS") {
                ...
                console.log('pdt: ' + pdt);
                console.log('getTopOrderedItems size '+response.getReturnValue().length ); 
    ...
    getSearchResults : function(component, event) {
        ...
        action.setCallback(this, function(response) {
            ...
            if(listSize != null && listSize >10000){
                ...
                component.set('v.data', response.getReturnValue());
                component.set('v.filteredData', response.getReturnValue());
                //component.set('v.filteredDataShow', response.getReturnValue());
            }
            //component.set('v.data', response.getReturnValue());
            //component.set('v.filteredData', response.getReturnValue());            
        } );
    ...
    sortData: function (component, fieldName, sortDirection) {
        var fname = fieldName;
        var data = component.get("v.filteredDataShow");
