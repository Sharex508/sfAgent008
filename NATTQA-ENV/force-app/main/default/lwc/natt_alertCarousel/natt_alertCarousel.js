...
import getAlerts from '@salesforce/apex/NATT_AlertCarouselController.getAlerts';
...
export default class Natt_alertCarousel extends LightningElement {
    @track progress = 8000; 
    @api titleText;
    @track hasNext = false;
    @track hasPrev = false;
    ...
    connectedCallback() {
        getAlerts()
            ...
            this._interval = setInterval(() => {  
               ...
               /* else if(this.hasNext == false && this.hasPrev == true ){
                    this.goPrev();
                } */
