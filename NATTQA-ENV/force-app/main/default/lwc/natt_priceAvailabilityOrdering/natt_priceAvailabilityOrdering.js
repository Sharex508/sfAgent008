...
export default class Natt_priceAvailabilityOrdering extends NavigationMixin(LightningElement) {
  @wire(MessageContext)
  messageContext;
   ...
   *
   * @type {natt_priceAvailabilityLineItem[]}
   */
  @track lineItems = [
    new natt_priceAvailabilityLineItem(null, null, null, null, 1),
    new natt_priceAvailabilityLineItem(null, null, null, null, 2),
    new natt_priceAvailabilityLineItem(null, null, null, null, 3),
    new natt_priceAvailabilityLineItem(null, null, null, null, 4),
    new natt_priceAvailabilityLineItem(null, null, null, null, 5)
  ];
  ...
  @track quickEntryLineItems = [
    ...
    new natt_priceAvailabilityLineItem(null, null, null, null, 4),
    new natt_priceAvailabilityLineItem(null, null, null, null, 5),
    new natt_priceAvailabilityLineItem(null, null, null, null, 6),
    new natt_priceAvailabilityLineItem(null, null, null, null, 7),
    new natt_priceAvailabilityLineItem(null, null, null, null, 8),
    new natt_priceAvailabilityLineItem(null, null, null, null, 9),
    new natt_priceAvailabilityLineItem(null, null, null, null, 10),
    new natt_priceAvailabilityLineItem(null, null, null, null, 11),
    new natt_priceAvailabilityLineItem(null, null, null, null, 12),
    new natt_priceAvailabilityLineItem(null, null, null, null, 13),
    new natt_priceAvailabilityLineItem(null, null, null, null, 14),
    new natt_priceAvailabilityLineItem(null, null, null, null, 15),
    new natt_priceAvailabilityLineItem(null, null, null, null, 16),
    new natt_priceAvailabilityLineItem(null, null, null, null, 17),
    new natt_priceAvailabilityLineItem(null, null, null, null, 18),
    new natt_priceAvailabilityLineItem(null, null, null, null, 19),
    new natt_priceAvailabilityLineItem(null, null, null, null, 20),
    new natt_priceAvailabilityLineItem(null, null, null, null, 21),
    new natt_priceAvailabilityLineItem(null, null, null, null, 22),
    new natt_priceAvailabilityLineItem(null, null, null, null, 23),
    new natt_priceAvailabilityLineItem(null, null, null, null, 24),
    new natt_priceAvailabilityLineItem(null, null, null, null, 25)
  ];
  ...
  handleAddRow() {
    ...
    for (i = 0; i < 5; i++) {
      emptyLineItems.push(
        new natt_priceAvailabilityLineItem(
          null,
          null,
          null,
          null,
  ...
  async handlePartNumberBlur(event) {
    ...
    if (enteredPartNumber === "") {
      this.lineItems[rowIndex] = new natt_priceAvailabilityLineItem(
        null,
        null,
        null,
        null,
   ...
   *
   *  @param {natt_priceAvailabilityLineItem[]} lineItemArray Array of line items to correct
   *  @returns {natt_priceAvailabilityLineItem[]} Original array with Row Numbers recalculatd
   */
  ...
  */
  ...
  async updateProductAsync(partNumber, quantity, rowIndex, supercededPartNumber) {
    ...
    if (productInfo !== "undefined") {
      ...
      newLineItem = new natt_priceAvailabilityLineItem(
        productInfo,
        availabilityResult,
        historyResult,
        userGuideResult,
  ...
  async handlePartNumberBlurQuickEntry(event) {    
    ...
    if (enteredPartNumber === "") {
      this.quickEntryLineItems[rowIndex] = new natt_priceAvailabilityLineItem(
        null,
        null,
        null,
        null,
