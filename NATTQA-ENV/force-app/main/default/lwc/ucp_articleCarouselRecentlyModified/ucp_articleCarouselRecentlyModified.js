...
import getRecentlyModifiedArticles from '@salesforce/apex/UCP_ArticleCarouselRecentlyController.getRecentlyModifiedArticles';
import ucpAssets from '@salesforce/resourceUrl/UCP_Community_Assets';
...
export default class ucp_articleCarouselRecentlyModified extends LightningElement {
        ...
        try {
            ...
            if (result.success) {
                result.data.forEach( (article, index) => {
                    article.iconImage = ucpAssets + '/CommunityAssets/icons/' + article.iconType + '.png';
                    article.image = ucpAssets + '/CommunityAssets/carrouselArticleTypeImage/' + article.image +'_'+this.userLang+ '.png';
